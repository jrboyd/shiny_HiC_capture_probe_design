### select individual probes targeting digest fragments
### Probe criteria:
# within fragment
# within 330 bp of  fragment end
# closest valid probe to at least one end of a fragment
### probes validated by Gviz plotting
### outputs:
# reference bed with per feature quantification or probes
# selected probes bed interval and probe id
# validation pdf
